...
<html>
    <head>
        <title>Cetak Data Kendaraan Hilang Perbulan</title>
            ...
            <div class='row'>
                <div class="col-sm-12">
                    ...
                    <div class="text-center">
                        ...
                        <h4>Jl. Ahmad Yani No.110, Kisaran Naga, Kec. Kisaran Tim.,<br> Kabupaten Asahan, Sumatera Utara 21211</h4>
                        <hr>
                        <h3>DATA KENDARAN HILANG PERBULAN   <? echo "$bulanNama $ambilthn"; ?></h3>
                ...
                <thead>
                            ...
                            $sql = "SELECT * FROM tbl_kejadian WHERE substr(tgl_masuk,1,7)='$ambilthn-$ambilbln'";
