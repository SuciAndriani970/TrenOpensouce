...
<html>
    <head>
        <title>Cetak Data Kendaran Hilang Pertahun</title>
            ...
            <div class='row'>
                <div class="col-sm-12">
                    ...
                    <div class="text-center">
                        ...
                        <hr>
                        <h3>DATA KENDARAAN HILANG PERTAHUN   <? echo "$ambilthn"; ?></h3>
                ...
                <thead>
                            ...
                            $sql = "SELECT * FROM tbl_kejadian WHERE substr(tgl_masuk,1,4)='$ambilthn'";
